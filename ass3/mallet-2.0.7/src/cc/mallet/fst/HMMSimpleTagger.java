...
public class HMMSimpleTagger
{
   ...
   *           
   */
  public static class HMMSimpleTaggerSentence2FeatureVectorSequence extends Pipe
  {
    // gdruck
     ...
     */
    public HMMSimpleTaggerSentence2FeatureVectorSequence ()
    {
    ...
    public Instance pipe (Instance carrier)
    {
      ...
      FeatureSequence fs = new FeatureSequence(features, tokens.length);
  ...
  private static final CommandOption.String weightsOption = new CommandOption.String(
      HMMSimpleTagger.class, "weights", "sparse|some-dense|dense", true, "some-dense",
  ...
  private static final CommandOption.Integer numThreads = new CommandOption.Integer(
      HMMSimpleTagger.class, "threads", "INTEGER", true, 1,
  ...
  public static void main (String[] args) throws Exception
  {
    ...
    if (continueTrainingOption.value || !trainOption.value) {
      ...
      p = new HMMSimpleTaggerSentence2FeatureVectorSequence();
    ...
    if (trainOption.value)
    {
      ...
      if (testOption.value != null)
      {
        ...
        {
          System.out.println("Training Fraction...."+trainingFractionOption.value);
    ...
    if (trainOption.value)
    {
      ...
      if (modelOption.value != null)
      {
    	System.out.println("Model option..."+modelOption.value);
