...
echo "order1"
java -cp "/home/madhav/Desktop/ass3/mallet-2.0.7/class:/home/madhav/Desktop/ass3/mallet-2.0.7/lib/mallet-deps.jar" cc.mallet.fst.SimpleTagger --include-input false --model-file ../pos.model.simple.order1 temp.pos.input > temp.pos.simple.order1.pred
...
<<Com
echo "order2"
java -cp "/home/madhav/Desktop/ass3/mallet-2.0.7/class:/home/madhav/Desktop/ass3/mallet-2.0.7/lib/mallet-deps.jar" cc.mallet.fst.SimpleTagger --include-input false --model-file ../pos.model.simple.order2 temp.pos.input > temp.pos.simple.order2.pred
