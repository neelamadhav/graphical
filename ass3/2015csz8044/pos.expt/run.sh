...
echo "simple"
java -cp $MALLET_INC cc.mallet.fst.SimpleTagger --include-input false --model-file pos.model.simple temp.pos.input > temp.pos.simple.pred
...
echo "order1"
java -cp $MALLET_INC cc.mallet.fst.SimpleTagger --include-input false --model-file pos.model.simple.order1 temp.pos.input > temp.pos.simple.order1.pred
...
<<Com
echo "order2"
java -cp $MALLET_INC cc.mallet.fst.SimpleTagger --include-input false --model-file pos.model.simple.order2 temp.pos.input > temp.pos.simple.order2.pred
...
echo "HMM"
java -cp $MALLET_INC cc.mallet.fst.HMMSimpleTagger --include-input false --model-file pos.model.hmm temp.pos.input > temp.pos.hmm.pred
...
java -cp $MALLET_INC cc.mallet.fst.SimpleTagger --include-input false --model-file pos.model.feature temp.pos.input.feature > temp.pos.feature.pred
...
java -cp $MALLET_INC cc.mallet.fst.SimpleTagger --include-input false --model-file pos.model.feature.specialChar.numerical temp.pos.input.feature > temp.pos.feature.specialChar.numerical.pred
...
java -cp $MALLET_INC cc.mallet.fst.SimpleTagger --include-input false --model-file pos.model.feature.specialChar.numerical.cap temp.pos.input.feature > temp.pos.feature.specialChar.numerical.cap.pred
...
java -cp $MALLET_INC cc.mallet.fst.SimpleTagger --include-input false --model-file pos.model.feature.specialChar.numerical.cap.mention.hashtag temp.pos.input.feature > temp.pos.feature.specialChar.numerical.cap.mention.hashtag.pred
