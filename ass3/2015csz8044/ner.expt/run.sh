...
echo "simple"
java -cp $MALLET_INC cc.mallet.fst.SimpleTagger --include-input false --model-file ner.model.simple temp.ner.input > temp.ner.simple.pred
...
echo "order1"
java -cp $MALLET_INC cc.mallet.fst.SimpleTagger --include-input false --model-file ner.model.simple.order1 temp.ner.input > temp.ner.simple.order1.pred
...
echo "order2"
java -cp $MALLET_INC cc.mallet.fst.SimpleTagger --include-input false --model-file ner.model.simple.order2 temp.ner.input > temp.ner.simple.order2.pred
...
echo "HMM"
java -cp $MALLET_INC cc.mallet.fst.HMMSimpleTagger --include-input false --model-file ner.model.HMM temp.ner.input > temp.ner.hmm.pred
...
java -cp $MALLET_INC cc.mallet.fst.SimpleTagger --include-input false --model-file ner.model.feature temp.ner.input.feature > temp.ner.feature.pred
...
java -cp $MALLET_INC cc.mallet.fst.SimpleTagger --include-input false --model-file ner.model.feature.specialChar.numerical temp.ner.input.feature > temp.ner.feature.specialChar.numerical.pred
...
java -cp $MALLET_INC cc.mallet.fst.SimpleTagger --include-input false --model-file ner.model.feature.specialChar.numerical.cap temp.ner.input.feature > temp.ner.feature.specialChar.numerical.cap.pred
...
java -cp $MALLET_INC cc.mallet.fst.SimpleTagger --include-input false --model-file ner.model.feature.specialChar.numerical.cap.mention.hashtag temp.ner.input.feature > temp.ner.feature.specialChar.numerical.cap.mention.hashtag.pred
...
java -cp $MALLET_INC cc.mallet.fst.SimpleTagger --include-input false --model-file ner.model.feature.all.pos temp.ner.input.feature > temp.ner.feature.all.pos.pred
